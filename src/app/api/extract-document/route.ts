...
- "ciudad": The city associated with the person. If you see a RUT, look for "Ciudad" or "Municipio" in the location/address section (usually box 39 or 40). Extract only the city name (e.g. "Bogotá", "Medellín", "Cali"). If not found, leave it empty.
